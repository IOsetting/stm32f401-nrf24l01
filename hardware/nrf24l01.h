...
#define CE(x)       x ? GPIO_SetBits(NRF24L01_GPIOx,NRF24L01_GPIO_CE) : GPIO_ResetBits(NRF24L01_GPIOx,NRF24L01_GPIO_CE);
#define CSN(x)      x ? GPIO_SetBits(NRF24L01_GPIOx,NRF24L01_GPIO_CSN) : GPIO_ResetBits(NRF24L01_GPIOx,NRF24L01_GPIO_CSN);
#define IRQ         GPIO_ReadInputDataBit(NRF24L01_GPIOx,NRF24L01_GPIO_IRQ)
